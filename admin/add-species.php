...
<body>
    <div class="species-main">
        ...
        <div class="species-container">
            <div class="species-info1">
                ...
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Science Name" value="" required data />
                    <label for="name" class="form__label">Tên khoa học</label>
                </div>
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Vietnamese Name" value="" required data />
                    <label for="name" class="form__label">Tên tiếng Việt</label>
                </div>
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Local Name" value="" required data />
            ...
            <div class="species-info1">
                ...
                <div class="form__group field">
                    <textarea name="" class="form__field textarea" id="" cols="30" rows="9" data></textarea>
                    <label for="name" class="form__label">Đặc điểm hình thái</label>
                </div>
                <div class="form__group field">
                    <textarea name="" class="form__field textarea" id="" cols="30" rows="6" data></textarea>
                    <label for="name" class="form__label">Đặc điểm sinh thái</label>
                </div>
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Specmen Codition" value="" required data />
            ...
            <div class="species-info1">
                ...
                <h1 class="center-h1">TỌA ĐỘ</h1>
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Coordinate S1" value="" required data />
                    <label for="name" class="form__label">Coordinate S1</label>
                </div>
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Coordinate S2" value="" required data />
                    <label for="name" class="form__label">Coordinate S2</label>
                </div>
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Coordinate S3" value="" required data />
                    <label for="name" class="form__label">Coordinate S3</label>
                </div>
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Coordinate S4" value="" required data />
                    <label for="name" class="form__label">Coordinate S4</label>
                </div>
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Coordinate S5" value="" required data />
                    <label for="name" class="form__label">Coordinate S5</label>
                </div>
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Location" value="" required data />
            ...
            <div class="species-info1">
                ...
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="GTSD" value="" required data />
                    <label for="name" class="form__label">Giá trị sử dụng</label>
                </div>
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Collection Date" value="" required data />
                ...
                <div class="form__group field">
                    <input type="input" class="form__field" placeholder="Collector" value="" required data />
        ...
        <div class="species-imges">
            <div class="species-images-item">
                <div class="image-item" style="background-image: url('https://bla.edu.vn/wp-content/uploads/2020/11/con-trau-trong-tieng-anh.jpg')">
                </div>
                <input type="text" class="files" placeholder="Link 1" value="" sub-data>
            </div>
            <div class="species-images-item">
                <div class="image-item" style="background-image: url('https://bla.edu.vn/wp-content/uploads/2020/11/con-trau-trong-tieng-anh.jpg')">
                </div>
                <input type="text" class="files" placeholder="Link 2" value="" sub-data>
            </div>
            <div class="species-images-item">
                <div class="image-item" style="background-image: url('https://bla.edu.vn/wp-content/uploads/2020/11/con-trau-trong-tieng-anh.jpg')">
                </div>
                <input type="text" class="files" placeholder="Link 3" value="" sub-data>
            </div>
            <div class="species-images-item">
                <div class="image-item" style="background-image: url('https://bla.edu.vn/wp-content/uploads/2020/11/con-trau-trong-tieng-anh.jpg')">
                </div>
                <input type="text" class="files" placeholder="Link 4" value="" sub-data>
            </div>
            <div class="species-images-item">
                <div class="image-item" style="background-image: url('https://bla.edu.vn/wp-content/uploads/2020/11/con-trau-trong-tieng-anh.jpg')">
                </div>
                <input type="text" class="files" placeholder="Link 5" value="" sub-data>
            </div>
            <script>
        ...
        <div class="species-button-group">
            <button onclick="sendData()">Thêm</button>
    ...
    <script>
        function sendData() {
            ...
            const subData = document.querySelectorAll('[sub-data]')
